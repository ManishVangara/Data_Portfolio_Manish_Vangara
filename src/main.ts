...
(function() {
  ...
  async function loadSkills(): Promise<void> {
    ...
    try {
      ...
      const skillCategories: SkillCategory[] = await response.json();
  ...
  // ============================================
  async function loadHobbies(): Promise<void> {
  ...
  // ============================================
  async function loadMyStory(): Promise<void> {
  ...
  // ============================================
  async function loadAskMe(): Promise<void> {
    ...
    try {
      ...
      const topics: AskMeTopic[] = await response.json();
  ...
  // ============================================
  function createCertificationCard(certification: Certification): HTMLDivElement {
    const card = document.createElement('div');
    card.className = 'card';
  ...
  // ============================================
  function createSkillCategoryCard(category: SkillCategory, _categoryIndex: number): HTMLDivElement {
  ...
  // ============================================
  function createExperienceItem(experience: Experience): HTMLDivElement {
  ...
  // ============================================
  function createEducationItem(education: Education): HTMLDivElement {
    const item = document.createElement('div');
    item.className = 'timeline-item';
  ...
  // CREATE HOBBY CARD
  // ============================================
  function createHobbyCard(hobby: Hobby): HTMLDivElement {
    const card = document.createElement('div');
  ...
  // CREATE STORY CARD
  // ============================================
  function createStoryCard(story: Story): HTMLDivElement {
    const card = document.createElement('div');
  ...
  // CREATE ASK ME CARD
  // ============================================
  function createAskMeCard(topic: AskMeTopic): HTMLDivElement {
    const card = document.createElement('div');
  ...
  // ============================================
  function loadDefaultProjects(container: HTMLElement): void {
    container.innerHTML = '';
  ...
  // ============================================
  function loadDefaultCertifications(container: HTMLElement): void {
    container.innerHTML = '';
  ...
  // LOAD DEFAULT SKILLS
  // ============================================
  function loadDefaultSkills(container: HTMLElement): void {
    container.innerHTML = '';
  ...
  // ============================================
  function loadDefaultExperience(container: HTMLElement): void {
    container.innerHTML = '';
  ...
  // ============================================
  function loadDefaultEducation(container: HTMLElement): void {
    container.innerHTML = '';
  ...
  // ============================================
  function loadDefaultHobbies(container: HTMLElement): void {
    container.innerHTML = '';
  ...
  // LOAD DEFAULT STORY
  // ============================================
  function loadDefaultStory(container: HTMLElement): void {
    container.innerHTML = '';
  ...
  // LOAD DEFAULT ASK ME
  // ============================================
  function loadDefaultAskMe(container: HTMLElement): void {
    container.innerHTML = '';

    const defaultTopics: AskMeTopic[] = [
      {
        icon: '💡',
  ...
  // ============================================
  function loadDefaultLessons(container: HTMLElement): void {
    container.innerHTML = '';
  ...
  // CONTACT BUTTON
  // ============================================
  function initContactButton(): void {
  ...
  function initNavigation(): void {
    const navLinks = document.querySelectorAll<HTMLAnchorElement>('.nav-btn');
    const footerLinks = document.querySelectorAll<HTMLAnchorElement>('.footer-links a');
  ...
  function initTypewriter(): void {
    ...
    function type() {
      ...
      if (isDeleting) {
        if (typewriterElement) typewriterElement.textContent = currentPhrase.substring(0, charIndex - 1);
        charIndex--;
      } else {
        if (typewriterElement) typewriterElement.textContent = currentPhrase.substring(0, charIndex + 1);
        charIndex++;
  ...
  function initMetricsCounter(): void {
    const metrics = document.querySelectorAll<HTMLElement>('.metric-value');
  ...
  function initParticleBackground(): void {
    ...
    // Particle class
    class ParticleClass implements ParticleInterface {
      x: number;
      y: number;
      size: number;
      speedX: number;
    ...
    // Cleanup function (not returned since function is void)
    const cleanup = () => {
    ...
    (window as any).__particleCleanup = cleanup;
  }
  ...
  // ============================================
  function initDownloadResume(): void {
